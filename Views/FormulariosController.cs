...
namespace Taller1.Views
{
    public class FormulariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cedula,Nombre,FechaNacimiento,Genero,Celular")] Formulario formulario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cedula,Nombre,FechaNacimiento,Genero,Celular")] Formulario formulario)
        {
            if (id != formulario.Id)
            {
                return NotFound();
